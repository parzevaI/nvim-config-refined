...
-- Function to automatically set tab width based on filetype
function M.auto_set_tab_width()
    ...
    -- Apply the tab width settings (same as SetTabWidth command)
    vim.opt.tabstop = tab_width
    vim.opt.shiftwidth = tab_width
    vim.opt.softtabstop = tab_width
end

-- Set up autocommands for automatic tab width setting
function M.setup()
